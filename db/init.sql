...
INSERT INTO admins (login, password, fio, telephone, mail)
VALUES
    ('admin1', '23412', 'Иванов Иван Иванович', '+79001234567', 'admin1@example.com'),
	('admin3', 'pass', 'Иванов Иван Иванович', '+79001234567', 'admin1@example.com'),
    ('admin2', '23123','Петров Петр Петрович', '+79112345678', 'admin2@example.com');
...
INSERT INTO mails (num_dog, fio, mail, opis)
VALUES
    ('516123456', 'Иванов Иван Иванович', 'borovinscky.yaroslaw@yandex.ru', 'Изменение тарифа'),
	('516901234', 'Кузнецов Алексей Владимирович', 'afonin-andrey2017@yandex.ru', 'Приобретение услуги'),
    ('516345678', 'Сидорова Мария Ивановна', 'katabymer@gmail.com', 'Отказ от услуг');
